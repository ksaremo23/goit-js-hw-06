...
// Get the attribute of <button type="button" data-create>Create</button>
const btnCreate = document.querySelector('[data-create]');
//Get the attribute of <button type="button" data-destroy>Destroy</button>
...
function createBoxes() {
  ...
  //Create new boxes with background color and adding 10px to previous
  let size= 30;
  ...
  function destroyBoxes() {
    // Clear the contents of div#Boxes once you click destry button
    divBoxes.innerHTML = '';
    inputElement.value = '';
  }
}